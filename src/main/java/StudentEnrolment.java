...
public class StudentEnrolment implements StudentEnrolmentManager {
    ...
    public int testInput() {
        ...
        if (Objects.equals(a, "abc") && Objects.equals(b, "def")) {
            return 1;
        } else {
            return 2;
        }
...
//                System.out.println("Input is String");
    ...
    public boolean add(Student student, String semester) throws IOException {
        ...
        BufferedWriter bw = new BufferedWriter(new FileWriter(System.getProperty("user.dir") + "\\src\\main\\java\\default.csv", true));
    ...
    public boolean delete(Student student, String semester) throws IOException {
        ...
        BufferedWriter bw = new BufferedWriter(new FileWriter(System.getProperty("user.dir") + "\\src\\main\\java\\default2.csv", false));
        ...
        File file = new File(System.getProperty("user.dir") + "\\src\\main\\java\\default.csv");
        file.delete();

        File file2 = new File(System.getProperty("user.dir") + "\\src\\main\\java\\default2.csv");
        file2.renameTo(file);
